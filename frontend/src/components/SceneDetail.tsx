...
export function SceneDetail({ templateId, onBack, onPlay, onToast }: SceneDetailProps) {
  ...
  return (
    <div className="mx-auto max-w-5xl py-8 px-4">
      ...
      {/* VIP Promo Banner */}
      <div className="relative overflow-hidden rounded-3xl border border-amber-500/20 bg-gradient-to-r from-amber-500/10 to-transparent p-6 sm:p-10 flex flex-col sm:flex-row items-center justify-between gap-6">
        ...
        <button onClick={() => onToast('VIP üyelik sistemi henüz aktif değil.')} className="relative z-10 shrink-0 rounded-xl bg-amber-500 px-8 py-3.5 text-sm font-black text-black hover:bg-amber-400 transition shadow-[0_0_20px_rgba(245,158,11,0.3)]">
